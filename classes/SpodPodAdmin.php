...
class SpodPodAdmin {
    ...
    public function addPages()
    {
        ...
        remove_menu_page('wc-spod');
        add_menu_page( __('Spreadconnect', 'wc-spod'), __('Spreadconnect','wc-spod'), 'manage_woocommerce', 'wc-spod', array(&$this, 'adminDisplay'), get_site_url(null, '/wp-content/plugins/wc-spod/admin/images/spod-icon-white.png'), 90 );
    }
